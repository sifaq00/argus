...
/**
 * ARGUS — Real-Time Geopolitical Events (GDELT 2.0 GeoJSON API)
...
export async function GET() {
  try {
    ...
    for (const rawItem of rawItems) {
      ...
      // Map GDACS event types to Argus types. WF and DR used to fall through
    ...
    console.error('[ARGUS] GDACS fetch error:', error);
