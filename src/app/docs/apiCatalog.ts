    ...
    endpoints: [
      {
        path: '/api/scanner',
        method: 'GET',
        summary: 'Runs a scan against a target via the ARGUS scanner backend.',
        params: [
          {
            name: 'type',
            required: true,
        ...
        notes:
          'Returns 503 when `SCANNER_URL` / `SCANNER_KEY` are unset — that is the supported way to disable RECON. `SCANNER_KEY` must equal the backend’s `ARGUS_KEY`.',
      },
    ],
  },
  {
